...
namespace NeosAssetImportHook
{
    ...
    {
        private class FakeTextureAssetProvider : IAssetProvider<Texture2D>
        {
            public Texture2D Asset => throw new NotImplementedException();
            ...
            public global::BaseX.RefID ReferenceID => throw new NotImplementedException();
            ...
            public void Load(global::BaseX.DataTreeNode node, LoadControl control)
            {
                throw new NotImplementedException();
            }
            ...
            public global::BaseX.DataTreeNode Save(SaveControl control)
            {
                throw new NotImplementedException();
            }
